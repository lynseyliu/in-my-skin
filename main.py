...
from dataloader import IsicLoader
...
def main():
    ...
    for epoch in range(args.epochs):  # loop over the dataset multiple times
        ...
        train(net, isicLoader, optimizer, criterion, epoch)
        if epoch % 1 == 0: # Comment out this part if you want a faster training
            test(net, isicLoader, 'Train')
            test(net, isicLoader, 'Test')
